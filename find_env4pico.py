...
def run_cegar(n_iteration, qedbtor, dutbtor):
    ...
    while not errFlag:
        ...
        subprocess.run(["./build/cexgen","--logging-smt-solver", "--property-file", "envinv.smt2",qedbtor])
        try:
...
if __name__ == '__main__':
     ...
     parser.add_argument('--qedbtor', type=str,default='/data/zhiyuany/EnvSynSamples/EnvSynSamples/QED/PICO/verification/pico.btor2')
     parser.add_argument('--dutbtor', type=str,default='/data/zhiyuany/EnvSynSamples/EnvSynSamples/QED/PICO/envinvsyn/design_new.btor')
