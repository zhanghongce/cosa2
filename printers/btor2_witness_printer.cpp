/*********************                                                        */
/*! \file btor2_witness_printer.cpp
 ** \verbatim
 ** Top contributors (to current version):
 **   Makai Mann, Hongce Zhang
...
static void print_btor_vals_at_time(const smt::TermVec & vec,
...
static void print_btor_vals_at_time(const std::map<uint64_t, smt::Term> m,
                             const smt::UnorderedTermMap & valmap,
                             unsigned int time)
{
  smt::SortKind sk;
